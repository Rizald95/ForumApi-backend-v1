...
class UserLoginUseCase {
    constructor({ userRepository, authenticationRepository, authenticationTokenManager, encryptionHelper }) {
    ...
    async execute(useCasePayload) {
        ...
        const encryptionPassword = await this._userRepository.getPasswordByUsername(username);
        await this._encryptionHelper.comparePassword(password, encryptionPassword);
